...
const RandomDish =  () => {
  ...
  <div className="container" >
    <div className="content">  <Card sx={{ maxWidth: 345 }}>
      <CardMedia
        component="img"
        height="250"
      ...
      <CardActions>
        <Button size="small" onClick={handleClick} color="secondary" >Skip</Button>
        <Button size="small" onClick={handleAddDish} color="primary">Add to Favourites</Button>
      </CardActions>
    </Card></div>
  </div> : null);
};
